...
<body>
    ...
    <h2>Download your scale positions sheet below</h2>

        <img src="../product-images/scale-shapes.jpg" alt="Guitar scale shapes">
    <a href="../downloads/scale-shapes.pdf" download>
